      ...
      host =
        ...
        in {
          ...
          riscv64 = rec {
            ...
            # TODO
            # Incompatible with the "cc" crate. Must do something like https://github.com/rust-lang/cc-rs/pull/460 (except for bare metal)
            # or https://github.com/rust-lang/cc-rs/pull/796 for riscv64gc-unknown-none-elf.
            # TODO will require KernelRiscvExtD in sel4test
            gc = {
              none = mkLeafWithGuard (rec {
                config = "riscv64-none-elf";
