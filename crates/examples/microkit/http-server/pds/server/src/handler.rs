...
use sel4_async_block_io::{access::ReadOnly, ConcreteConstantBlockSize};
...
pub(crate) struct HandlerImpl {
    ...
    shared_block_io: SharedRingBufferBlockIO<ConcreteConstantBlockSize<512>, ReadOnly, Basic, fn()>,
